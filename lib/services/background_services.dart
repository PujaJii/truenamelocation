...
//                   // Display your custom text when data is not available
//                   return Text("Service is running, but data is not available.");
//                 }
//
//                 return Column(
//                   children: [
...
//             //     return Column(
//             //       children: [
//             //         Text(device ?? 'Unknown',style: TextStyle(color: Colors.black)),
