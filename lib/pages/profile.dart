...
class _ProfileState extends State<Profile> {
  ...
  void initState() {
   // getLocation();
    //print(_specifiedLocation.latitude);
    //print(_specifiedLocation.longitude);
    super.initState();
  }
      ...
      if (controller.isLoading.value) {
        ...
        return
          ...
          appBar: AppBar(
            ...
            title:  Column(
              children: [
                Text("${controller.userProfile[0].firstName.toString()} ${controller.userProfile[0].lastName.toString()}", style: const TextStyle(color: Colors.black)),
